...
function SiteHeader() {
  ...
  return (
    <header
      data-nav-shell
      className="relative z-30 mx-auto my-3 flex w-[calc(100%-8px)] items-center justify-between border-2 border-[#111111] bg-white shadow-[5px_5px_0_#9f9f9f] sm:my-4 sm:w-[calc(100%-12px)] lg:my-6 lg:w-fit lg:justify-start"
    >
      <button
        type="button"
        data-nav-brand
      ...
      >
        <span className="font-['Syne'] text-base font-black">
          {isOpen ? "X" : "≡"}
        </span>
      </button>
