...
function CtaSection() {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    const payload = {
      ...
      organization:
        String(formData.get("organization") ?? "").trim() || undefined,
      profileLink:
        String(formData.get("profileLink") ?? "").trim() || undefined,
    ...
    <>
      ...
      >
        <div className="mx-auto w-full max-w-300">
          <div
            data-cta-box
            className="border-2 border-[#111111] bg-[#f8f8f8] px-4 py-8 shadow-[5px_5px_0_#9f9f9f] sm:px-4.5 sm:py-8.5"
          >
            ...
            <form
              className="mx-auto grid w-full max-w-215 grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-4"
